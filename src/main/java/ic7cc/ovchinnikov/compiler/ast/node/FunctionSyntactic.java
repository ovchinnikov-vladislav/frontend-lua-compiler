...
//            // TODO not correct
//            prefixexp = new PrefixExpressionLPExpressionRPNode(new LiteralStringExpressionNode(funcNameVar.getNameNode().getName()));
//        }
//
//        @Override
//        public void visit(FunctionNameVarDotFunctionNameNode funcNameVarDotFuncName) {
//            if (funcNameVarDotFuncName.getFunctionName() instanceof FunctionNameVarNode) {
//                FunctionNameVarNode fn = (FunctionNameVarNode) funcNameVarDotFuncName.getFunctionName();
