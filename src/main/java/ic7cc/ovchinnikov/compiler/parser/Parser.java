...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Jun 02 00:37:29 MSK 2020
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		FunctionBodyNode fb = (FunctionBodyNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
                                                                       ...
                                                                       /* VariableListNode vl = FunctionSyntactic.funcNameToVarList(fn);
                                                                        vl.setStart(fn.getStart());
                                                                        vl.setEnd(fn.getEnd());

                                                                        ExpressionListNode args = FunctionSyntactic.methodDefinitionToExpression(fn, fb);
                                                                        args.setStart(fb.getStart());
                                                                        args.setEnd(fb.getEnd());

                                                                        AssignmentNode asm = new AssignmentNode(vl, args);
