...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Jun 01 13:59:55 MSK 2020
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
                                                    ...
                                                    RESULT = new PrefixExpressionExpressionNode(e);
		...
		FunctionBodyNode fb = (FunctionBodyNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		  RESULT = new FunctionExpressionNode(fb.getArgs(), fb.getVarArgs(), fb.getBlockNode()); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expression",10, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		ExpressionListNode el = (ExpressionListNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
          ...
          case 24: // comforexp ::= empty 
            {
              Expression RESULT =null;
		  RESULT = new NumeralExpressionNode(1.0, NumeralExpressionNode.Type.DOUBLE); 
		...
		int fbright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		FunctionBodyNode fb = (FunctionBodyNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		  RESULT = new LocalFunctionDefinitionNode(nameNode, fb.getArgs(), fb.getVarArgs(), fb.getBlockNode()); 
